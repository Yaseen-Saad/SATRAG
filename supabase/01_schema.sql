...
CREATE TABLE IF NOT EXISTS vocab_entries (
    ...
    quality_tier TEXT CHECK (quality_tier IN ('unranked', 'trash', 'fixed-trash','bronze', 'silver', 'gold', 'platinum', 'diamond')),
...
CREATE TABLE IF NOT EXISTS public_profiles (
    ...
    reminder_digest_hour SMALLINT NOT NULL DEFAULT 17,
